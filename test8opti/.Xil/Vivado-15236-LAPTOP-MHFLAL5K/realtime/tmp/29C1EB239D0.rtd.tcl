...
set genomeRtd $env(RT_TMP)/29C1EB239D0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {strassen_scratchpad__GB16}]"
...
set genomeName [subst -nocommands -novariables {strassen_scratchpad__GB16}]
