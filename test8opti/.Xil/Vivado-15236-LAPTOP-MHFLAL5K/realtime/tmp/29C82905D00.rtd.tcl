...
set genomeRtd $env(RT_TMP)/29C82905D00.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {posit_mac_array__GB3}]"
...
set genomeName [subst -nocommands -novariables {posit_mac_array__GB3}]
