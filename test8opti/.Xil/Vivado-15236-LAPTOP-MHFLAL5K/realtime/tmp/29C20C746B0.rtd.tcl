...
set genomeRtd $env(RT_TMP)/29C20C746B0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {strassen_scratchpad__GB18}]"
...
set genomeName [subst -nocommands -novariables {strassen_scratchpad__GB18}]
