...
if { $debug_rtd_standalone } {
  set rt::partid xczu5ev-sfvc784-3-e
  if { ! [info exists ::env(RT_TMP)] } {
    set ::env(RT_TMP) [pwd]
  } 
  source $::env(SYNTH_COMMON)/task_worker.tcl
} 
set genomeRtd $env(RT_TMP)/29C652D02F0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {strassen_scratchpad__GB14}]"
...
set genomeName [subst -nocommands -novariables {strassen_scratchpad__GB14}]
