...
def compute_q124_gemm(matrix_a, matrix_b, M, K, N, use_relu=True):
...
def main(weights="../test8bit/weights_resnet50_cifar10_seed42_fp32.pth", dataset="cifar10", layer_indices=None):
    print("=" * 80)
    print("  ResNet-50 Multi-Layer Hardware Validation: 16-Bit Fixed-Point (Q12.4) Baseline")
    print("=" * 80)
    ...
    for idx in layer_indices:
        ...
        hw_c = compute_q124_gemm(matrix_a, matrix_b, M, K, N, use_relu=True)
    ...
    print("\n" + "=" * 80)
    print("Verified Status   : SUCCESS (16-Bit Fixed-Point Q12.4 Baseline Validation)")
    print("=" * 80 + "\n")
