// =============================================================================
// eval_tb.v — Testbench for 64x64 matrix multiplication accuracy evaluation
// =============================================================================
`timescale 1ns/1ps
...
module eval_tb;
    ...
    // Instantiate strassen_top configured for fixed-point GEMM
    strassen_top #(
        .SZI(8),
        .SZJ(8),
        .DATA_WIDTH(8),
    ...
    // Memory buffers to hold the input test vectors
    reg [63:0] mem_a [0:31];
    reg [63:0] mem_b [0:31];
